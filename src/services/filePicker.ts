...
// Files-app picker for anything that isn't a Photos/Camera-Roll asset. The
// Photos branch lives in PhotoPickerScreen because it needs full control
// over the iOS permission scope.
